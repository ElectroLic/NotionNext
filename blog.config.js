...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，你好鸭O(∩_∩)O, Emm...你怎么会在这里呢?,Emm...是迷路了吗(T_T),别管了...先进来看看吧🎉',
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '2960201@student.gla.ac.uk', // 邮箱地址 例如mail@tangly1024.com
